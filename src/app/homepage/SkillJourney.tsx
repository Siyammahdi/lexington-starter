    ...
    return (
        <div className="relative text-white">
            ...
            <div className="max-w-6xl mx-auto text-center px-4">
                <GradientTitle className="text-5xl w-2/5 mx-auto" text="A skill building journey with Vanta" />
                ...
                <div className="flex flex-col md:flex-row gap-6 items-center justify-center">
                    ...
                    <div className='bg-gradient-to-b from-black/70 to-neutral-800/70 rounded-3xl border border-neutral-800  -rotate-12'>
                        <div className="bg-gradient-to-b from-neutral-900/30 to-neutral-800/30 rounded-2xl border border-neutral-800 shadow-md m-[6px] text-center space-y-4 ">
                            <div className=" text-left p-12 rounded-xl shadow-lg max-w-sm md:max-w-xs">
